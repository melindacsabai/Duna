    ...
    which.addEventListener("change", function () {
        ...
        switch (true) {
            ...
            case hatterOne.checked:
                ...
                textarea.style.backgroundImage = "url('assets/img/sergiu-gabriel-LIEmOHJOx_c-unsplash.jpg')";
            ...
            case hatterTwo.checked:
                textarea.style.backgroundImage = "url('assets/img/nenad-radojcic-G2yQxpUGiaM-unsplash.jpg')";
                textarea.style.backgroundSize = "cover";
            ...
            case hatterThree.checked:
                textarea.style.backgroundImage = "url('assets/img/alana-harris-nxEQJzHQMJ0-unsplash\ \(1\).jpg')";
                textarea.style.backgroundSize = "cover";
            ...
            case hatterFour.checked:
                textarea.style.backgroundImage = "url('assets/img/ian-wagg-a6f968XpMRo-unsplash.jpg')";
                textarea.style.backgroundSize = "cover";
